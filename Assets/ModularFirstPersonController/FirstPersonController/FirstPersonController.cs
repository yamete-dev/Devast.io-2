...
public class FirstPersonController : MonoBehaviour
{
    ...
    public KeyCode switchViewKey = KeyCode.Z; // or any other key you prefer
    ...
    void Start()
    {
        ...
        Debug.Log("sprintBarCG: " + sprintBarCG);
    ...
    private void Update()
    {
        ...
        // Assuming this code is within an Update or similar method:
        // if (enableZoom)
        // {

        //     if (Input.GetKeyDown(switchViewKey)) // switchViewKey is the key to toggle between views
        //     {
        //         currentView = (currentView == CameraView.ThirdPerson) ? CameraView.TopDown : CameraView.ThirdPerson;
